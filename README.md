...
- What is the total & average sales and total profit & quantity sold?
- Which category and sub-category generate the highest sales?
- Which customer segment has the highest profit percentage?
...
- Total sales is 2.3M & average sales is 60.7 and total profit is 286.4K & total quantity is 38K
- Technology is the top-performing category (0.84M sales) and Phones lead sub-categories (0.34M sales)
- Consumer segment contributes the highest profit (46.8%)
...
- Target Profitable Customer Segment
...
- Delivered an interactive Power BI dashboard that provides a complete view of sales, profit, and customer behavior.
- Identified top-performing categories (Technology, Phones) and high-profit segments (Consumer).
